...
- **GSAP SplitText plugin**: Paid plugin ($99/year Club GreenSock) for editorial text reveals. Handles word/char splitting with responsive reflow and accessibility concerns. Manual split rejected due to whitespace/wrapping complexity.
