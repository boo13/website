  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'sandbox-3d': resolve(import.meta.dirname, 'sandbox-3d.html'),
        'sandbox-3d-depth': resolve(import.meta.dirname, 'sandbox-3d-depth.html'),
        'sandbox-3d-particles': resolve(import.meta.dirname, 'sandbox-3d-particles.html'),
